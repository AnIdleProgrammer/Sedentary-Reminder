...
namespace Reminder
{
    public class GlobalVariable
    {
        ...
        private readonly String SOFTWARE_VERSION = @"Version 1.0";
        private readonly String GITHUB_LINK = @"https://github.com/AnIdleProgrammer/Sedentary-Reminder";
